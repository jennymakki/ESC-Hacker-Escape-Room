  ...
  return (
    <section className="relative overflow-hidden py-28 px-6 flex justify-center  text-white">
      <article className="relative max-w-3xl flex flex-col items-center px-5 text-center">
        ...
        <button className="mt-12 mb-16 w-[260px] group relative overflow-hidden cursor-pointer border border-[#E3170A] bg-[#E3170A] text-white rounded px-6 py-4 text-lg font-bold transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(227,23,10,.45)]">
